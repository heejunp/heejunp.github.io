...
export const experiences = [
  ...
  },
  {
    ...
    period: "2024.02",
    description: ["Bachelor's Degree in Electronic Engineering."],
  },
];
...
export const projects = [
  {
    ...
    description:
      "A Vercel-like PaaS platform engineered for on-premise Kubernetes clusters. It empowers developers with a seamless 'push-to-deploy' experience, abstracting infrastructure complexity while ensuring operational scalability.",
    tags: [
      TECH_TAGS.GO,
      TECH_TAGS.ECHO,
      TECH_TAGS.DOCKER,
      TECH_TAGS.KUBERNETES,
      TECH_TAGS.ARGOCD,
      TECH_TAGS.GITHUB_ACTIONS,
    ...
    review:
      "By resolving cluster-wide RBAC issues and Docker build path challenges, I enhanced the stability of GitOps operations. This project highlights my focus on designing infrastructure that prioritizes operational efficiency beyond the development phase.",
  },
  {
    title: "JangsaManLab",
    category: ProjectCategory.FULLSTACK,
    ...
    description:
      "A comprehensive business management platform enabling owners to focus on operations by automating attendance tracking, payroll calculations, team communication, and insurance management.",
    tags: [
      TECH_TAGS.SVELTEKIT,
      TECH_TAGS.FIREBASE,
      TECH_TAGS.PWA,
    ...
    review:
      "As a solo developer, I maximized productivity by adopting 'Vibe Coding' with AI tools. However, I learned that over-reliance and accepting AI suggestions without critical review could lead to unexpected bugs. This experience taught me that while AI is a powerful accelerator, the final verification of logic remains the engineer's responsibility. I also reaffirmed the importance of systematic component design and refactoring for long-term maintenance.",
  },
  {
    title: "Linky",
    ...
    description:
      "Autonomous delivery robot designed for park environments, utilizing SLAM for self-driving navigation and providing AI-enhanced delivery services.",
    tags: [
      TECH_TAGS.KUBERNETES,
      TECH_TAGS.JENKINS,
      TECH_TAGS.ARGOCD,
  ...
  },
  {
    ...
    description:
      "An AI-powered real estate platform that recommends properties, summarizes key listing details, and evaluates market value to assist effective decision-making.",
    tags: [
      TECH_TAGS.OPENAI,
      TECH_TAGS.SPRING_BOOT,
      TECH_TAGS.VUEJS,
      TECH_TAGS.TAILWIND,
      TECH_TAGS.MYSQL,
      TECH_TAGS.REDIS,
  ...
  },
  {
    ...
    description:
      "Microservices Architecture (MSA) project functions as a scalable bookstore platform. Orchestrated distributed services using Spring Boot and RabbitMQ, integrating Elasticsearch for search and Redis for caching.",
    tags: [
      TECH_TAGS.MSA,
      TECH_TAGS.SPRING_BOOT,
      TECH_TAGS.MYSQL,
...
export const projectsKo = [
  {
    ...
    teamSize: "1명 (개인 프로젝트)",
    description:
      "Vercel과 같은 매끄러운 배포 경험을 온프레미스 환경에 구현한 PaaS 플랫폼입니다. 'Push-to-Deploy' 방식을 통해 개발자는 인프라 설정 없이 코드 작성에만 집중할 수 있으며, 쿠버네티스의 복잡함을 추상화하여 운영 효율성을 극대화했습니다.",
    tags: [
      TECH_TAGS.GO,
      TECH_TAGS.ECHO,
      TECH_TAGS.DOCKER,
    ...
    review:
      "클러스터 범위의 리소스 접근 권한 문제(RBAC)나 Docker 빌드 시 발생한 파일 경로 문제 등을 해결하며 GitOps의 운영 안정성을 높였습니다. 단순 기능을 구현하는 것에서 나아가, 실제 운영 환경에서의 안정성과 효율성을 깊이 있게 고민하고 인프라를 설계하는 엔지니어링 역량을 기르고 있습니다.",
  },
  {
    title: "JangsaManLab",
    category: ProjectCategory.FULLSTACK,
    ...
    teamSize: "1명",
    description:
      "사장님들의 운영 업무를 돕는 통합 비즈니스 관리 플랫폼입니다. 근태 관리, 급여 정산, 팀 소통, 보험 관리 등을 자동화합니다.",
    tags: [
      TECH_TAGS.SVELTEKIT,
      TECH_TAGS.FIREBASE,
      TECH_TAGS.PWA,
    ...
    review:
      "1인 개발로서 처음으로 '바이브 코딩'을 적용하여 생산성을 극대화했습니다. 하지만 AI 의존도가 높아지며 충분한 고민 없이 코드를 수용(Accept)해 예기치 못한 버그를 마주하기도 했습니다. 이를 통해 AI는 강력한 도구지만, 코드의 논리적 결함을 걸러내는 것은 결국 개발자의 몫임을 뼈저리게 느꼈습니다. 이와 더불어 체계적인 컴포넌트 설계와 리팩토링이 장기적인 유지보수에 얼마나 중요한지도 깊이 깨달았습니다.",
  },
  {
    title: "Linky",
    category: ProjectCategory.INFRASTRUCTURE,
    ...
    teamSize: "6명 (팀원)",
    description:
      "공원 환경을 위한 자율 주행 배달 로봇으로, SLAM 기술을 활용한 자율 주행과 AI 기반 배달 편의 서비스를 제공합니다.",
    tags: [
      TECH_TAGS.KUBERNETES,
      TECH_TAGS.JENKINS,
      TECH_TAGS.ARGOCD,
    ...
    review:
      "하드웨어와 소프트웨어가 결합된 로봇(Edge Device) 환경은 일반 서버와 달리 배포 관리가 복잡했습니다. 이에 ArgoCD 기반의 GitOps를 도입하여, 물리적 제약 없이 코드 변경 사항이 로봇에 즉시 동기화되도록 구성했습니다. 이를 통해 복잡한 배포 프로세스를 선언적(Declarative)으로 관리하고, 하드웨어 테스트 주기를 획기적으로 단축하는 성과를 거뒀습니다. 이 과정에서 체감한 인프라 오케스트레이션의 강력함은, 제가 쿠버네티스 엔지니어라는 진로를 확신하게 된 결정적인 계기가 되었습니다.",
  },
  {
    title: "JipPickT",
    category: ProjectCategory.FULLSTACK,
    ...
    teamSize: "2명 (팀장)",
    description:
      "AI 기반 부동산 추천 플랫폼으로, 매물 정보를 요약하고 적정 시세를 분석하여 사용자의 효율적인 의사결정을 돕습니다.",
    tags: [
      TECH_TAGS.OPENAI,
      TECH_TAGS.SPRING_BOOT,
      TECH_TAGS.VUEJS,
    ...
    review:
      "퍼블릭 클라우드 없이 베어메탈(Mini PC) 환경에 배포하며, 네트워크 구성과 리소스 관리 등 온프레미스 환경의 제약 사항을 직접 해결했습니다. 또한, 소규모 팀의 빠른 프로토타이핑을 지원하기 위해 Jenkins를 활용한 CI/CD 파이프라인을 구축하여 배포 자동화를 이뤄냈습니다. 이를 통해 퍼블릭 클라우드 환경 너머의 시스템 운영 원리를 깊이 이해하게 되었습니다.",
  },
  {
    title: "Buzz Book",
    category: ProjectCategory.BACKEND,
    ...
    teamSize: "6명 (팀장)",
    description:
      "MSA 아키텍처 기반의 확장 가능한 온라인 서점 플랫폼입니다. Spring Boot와 RabbitMQ를 사용하여 분산 서비스를 조율하고, Elasticsearch와 Redis를 통합하여 검색 및 캐싱 성능을 최적화했습니다.",
    tags: [
      TECH_TAGS.MSA,
      TECH_TAGS.SPRING_BOOT,
      TECH_TAGS.MYSQL,
